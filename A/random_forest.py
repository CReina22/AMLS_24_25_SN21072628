...
def random_forest_model(x_train, x_val, x_test, y_train_labels, y_val_labels, y_test_labels):
   ...
   #             'max_leaf_nodes': [10, 20, 30]}
    ...
    rf = RandomForestClassifier(max_depth= 10, n_estimators= 200, max_leaf_nodes= 10, min_samples_leaf= 1, min_samples_split= 10, random_state= 20, class_weight='balanced')
